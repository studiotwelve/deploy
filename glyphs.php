<?php function render_icon($s,$p){$classes=explode(",", $s);$c=$classes;foreach($c as $v){$t=str_replace($p,'',$v);$t=str_replace('-',' ',$t);$t=ucwords($t);$n=str_replace('.','',$v);print('<li class="item"><span class="title">'. $t .'</span><span class="example"><i class="'. $n .'"></i></span><span class="class-name">'.$v.'</span></li>'."\n");}}
